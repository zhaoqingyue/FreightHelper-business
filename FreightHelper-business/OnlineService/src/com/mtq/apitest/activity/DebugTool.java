...
public class DebugTool {
	public static void saveFile(String str) {
		...
		if (hasSDCard) {
			filePath = Environment.getExternalStorageDirectory().toString() + File.separator + "MTQFreightHelperFile/debug3.txt";
		} else
			filePath = Environment.getDownloadCacheDirectory().toString() + File.separator + "MTQFreightHelperFile/debug3.txt";
