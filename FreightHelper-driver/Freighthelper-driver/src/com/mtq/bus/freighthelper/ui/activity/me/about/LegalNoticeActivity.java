...
public class LegalNoticeActivity extends BaseActivity implements OnClickListener {
	...
	protected void initData() {
		mTitle.setText(R.string.about_legal_notice);
