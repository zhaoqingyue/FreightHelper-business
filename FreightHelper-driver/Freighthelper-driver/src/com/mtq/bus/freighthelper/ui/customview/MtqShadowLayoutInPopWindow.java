...
public class MtqShadowLayoutInPopWindow extends FrameLayout {
    ...
    public MtqShadowLayoutInPopWindow(Context context) {
        super(context);
        initView(context, null);
    }

    public MtqShadowLayoutInPopWindow(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public MtqShadowLayoutInPopWindow(Context context, AttributeSet attrs, int defStyleAttr) {
