...
public class WheelDayAdapter extends AbstractWheelTextAdapter {

	private List<String> list = new ArrayList<String>();
	
	public WheelDayAdapter(Context context, int year, int month) {
		super(context);
		
		setItemResource(R.layout.item_wheel);
		setItemTextResource(R.id.item_wheel_name);
		list = DateUtils.getDayList(year, month);
	}
