...
public class MtqScheduleAudioFile {
	 //音频输入-麦克风 
    public final static int AUDIO_INPUT = MediaRecorder.AudioSource.DEFAULT; 
      
    //采用频率 
    //44100是目前的标准，但是某些设备仍然支持22050，16000，11025 
    //为了用户节省流量,采用频率4000的,低频率录制
    public static int AUDIO_SAMPLE_RATE = 4000;  //44.1KHz,普遍使用的频率    
    //录音输出文件 
    private final static String AUDIO_RAW_FILENAME = "RawAudio.raw"; 
    public final static String AUDIO_WAV_FILENAME = "FinalAudio.wav"; 
